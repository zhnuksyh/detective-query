...
export default function MainMenu({ game, play }) {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      {/* Version + repo link, bottom-right. */}
      <div className="absolute bottom-4 right-5 z-10 flex items-center gap-3 text-zinc-400">
        <a
          href={REPO_URL}
          target="_blank"
        ...
        <span className="text-[11px] tracking-widest text-zinc-500">{VERSION}</span>
      </div>
